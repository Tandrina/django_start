...
SECRET_KEY = 'django-insecure-fnb_^rcy6c5k3&^v%!j=7k(y6gzrkc9i_1l^e#@0$(jk0ea&=8'
...
INSTALLED_APPS = [
    ...
    'django.contrib.auth',   # отвечает за группу AUTHENTICATION AND AUTHORIZATION
    ...
    'django.contrib.sites',   # фреймворк для работы с простыми страницами
    'django.contrib.flatpages',   # фреймворк для работы с простыми страницами
    'fpages'
]
